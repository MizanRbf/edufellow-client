...
const ManageScholarDetailsCard = ({ singleScholarship }) => {
  ...
  return (
    <div>
      <div className="border border-primary shadow-md rounded-sm flex flex-col lg:flex-row gap-6 p-5 bg-white">
        ...
        <div className="w-full lg:w-2/3 space-y-2 text-sm text-gray-700">
          <h1 className="text-xl font-bold text-primary">{scholarship_name}</h1>
          <p>
          ...
          <p>
            <span className="font-semibold">Location:</span> {university_city},{" "}
            {university_country}
          </p>
          <p>
          ...
          <p>
            <span className="font-semibold">Subject:</span> {subject_category}
          </p>
          <p>
            <span className="font-semibold">Tuition Fees:</span> {tuition_fees}
          </p>
          <p>
